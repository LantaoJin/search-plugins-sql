...
import org.opensearch.sql.velox.VeloxExecutionEngineAbstract;

public class VeloxPPLIntegTestCase extends PPLIntegTestCase {
  private static final String EXPLAIN_SUBSTRAIT = "/_plugins/_ppl/_explain";
  protected PPLService pplService;

  @Override
  public void init() throws IOException {
    RestHighLevelClient restClient =
        new VeloxPPLIntegTestCase.InternalRestHighLevelClient(client());
    ...
    modules.add(
        new VeloxPPLIntegTestCase.StandaloneModule(
            new VeloxPPLIntegTestCase.InternalRestHighLevelClient(client()),
            getSettings(),
            dataSourceService));
  ...
  protected String explainQuery(String query) {
    AtomicReference<String> actual = new AtomicReference<>();
    pplService.explain(
        new PPLQueryRequest(query, null, EXPLAIN_SUBSTRAIT, "substrait"),
        new ResponseListener<ExecutionEngine.ExplainResponse>() {
          ...
          public void onResponse(ExecutionEngine.ExplainResponse response) {
            ...
            actual.set(formatter.format(response));
          }
  ...
  public class StandaloneModule extends AbstractModule {
    ...
    public ExecutionEngine executionEngine(
      ...
      return new VeloxExecutionEngineAbstract();
    }
